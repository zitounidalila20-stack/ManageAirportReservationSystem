...
declare function GoogleLogin({ onSuccess, onError, useOneTap, promptMomentNotification, type, theme, size, text, shape, logo_alignment, width, click_listener, state, containerProps, login_hint, ...props }: GoogleLoginProps): JSX.Element;
